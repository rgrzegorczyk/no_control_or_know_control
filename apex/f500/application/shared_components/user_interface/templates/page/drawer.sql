...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(29297981033373317)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29298219311373326)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29298532382373327)
,p_page_template_id=>wwv_flow_imp.id(29297981033373317)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29298803206373327)
,p_page_template_id=>wwv_flow_imp.id(29297981033373317)

...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(29320012715373350)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29320392460373350)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29320667003373350)
,p_page_template_id=>wwv_flow_imp.id(29320012715373350)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29320969198373350)
,p_page_template_id=>wwv_flow_imp.id(29320012715373350)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29321221042373351)
,p_page_template_id=>wwv_flow_imp.id(29320012715373350)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29321535349373351)
,p_page_template_id=>wwv_flow_imp.id(29320012715373350)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29321892138373351)
,p_page_template_id=>wwv_flow_imp.id(29320012715373350)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29322185963373351)
,p_page_template_id=>wwv_flow_imp.id(29320012715373350)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29322440723373351)
,p_page_template_id=>wwv_flow_imp.id(29320012715373350)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29322793996373351)
,p_page_template_id=>wwv_flow_imp.id(29320012715373350)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29323056419373351)
,p_page_template_id=>wwv_flow_imp.id(29320012715373350)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29323320725373352)
,p_page_template_id=>wwv_flow_imp.id(29320012715373350)

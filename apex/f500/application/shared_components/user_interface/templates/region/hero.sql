...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29366878336373385)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29367156115373386)
,p_plug_template_id=>wwv_flow_imp.id(29366878336373385)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29367455310373386)
,p_plug_template_id=>wwv_flow_imp.id(29366878336373385)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29367762792373386)
,p_plug_template_id=>wwv_flow_imp.id(29366878336373385)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29368041625373387)
,p_plug_template_id=>wwv_flow_imp.id(29366878336373385)
,p_name=>'Sub Regions'

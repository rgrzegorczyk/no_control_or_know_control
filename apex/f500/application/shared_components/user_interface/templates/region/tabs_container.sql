...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29409627424373410)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29409983108373411)
,p_plug_template_id=>wwv_flow_imp.id(29409627424373410)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29410241523373411)
,p_plug_template_id=>wwv_flow_imp.id(29409627424373410)
,p_name=>'Tabs'

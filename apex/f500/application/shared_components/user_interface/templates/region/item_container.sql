...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29392165596373400)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29392412734373400)
,p_plug_template_id=>wwv_flow_imp.id(29392165596373400)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29392783420373400)
,p_plug_template_id=>wwv_flow_imp.id(29392165596373400)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29393000763373400)
,p_plug_template_id=>wwv_flow_imp.id(29392165596373400)
,p_name=>'Button Start'

...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29352705667373377)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29353098341373378)
,p_plug_template_id=>wwv_flow_imp.id(29352705667373377)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29353325643373378)
,p_plug_template_id=>wwv_flow_imp.id(29352705667373377)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29353690157373378)
,p_plug_template_id=>wwv_flow_imp.id(29352705667373377)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29353959318373378)
,p_plug_template_id=>wwv_flow_imp.id(29352705667373377)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29354208957373378)
,p_plug_template_id=>wwv_flow_imp.id(29352705667373377)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29354537863373378)
,p_plug_template_id=>wwv_flow_imp.id(29352705667373377)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29354899848373378)
,p_plug_template_id=>wwv_flow_imp.id(29352705667373377)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29355116901373379)
,p_plug_template_id=>wwv_flow_imp.id(29352705667373377)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29355412551373379)
,p_plug_template_id=>wwv_flow_imp.id(29352705667373377)
,p_name=>'Sub Regions'

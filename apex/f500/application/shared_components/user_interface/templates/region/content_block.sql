...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29362255148373383)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29362549736373383)
,p_plug_template_id=>wwv_flow_imp.id(29362255148373383)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29362848106373383)
,p_plug_template_id=>wwv_flow_imp.id(29362255148373383)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29363144011373383)
,p_plug_template_id=>wwv_flow_imp.id(29362255148373383)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29363434523373383)
,p_plug_template_id=>wwv_flow_imp.id(29362255148373383)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29363703787373383)
,p_plug_template_id=>wwv_flow_imp.id(29362255148373383)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29364012650373384)
,p_plug_template_id=>wwv_flow_imp.id(29362255148373383)
,p_name=>'Sub Regions'

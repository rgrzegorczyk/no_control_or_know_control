...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29335271015373366)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29335522131373366)
,p_plug_template_id=>wwv_flow_imp.id(29335271015373366)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29335887246373366)
,p_plug_template_id=>wwv_flow_imp.id(29335271015373366)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29336166131373367)
,p_plug_template_id=>wwv_flow_imp.id(29335271015373366)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29336430086373367)
,p_plug_template_id=>wwv_flow_imp.id(29335271015373366)
,p_name=>'Sub Regions'

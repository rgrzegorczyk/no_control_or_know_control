...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29380030879373393)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29380376178373394)
,p_plug_template_id=>wwv_flow_imp.id(29380030879373393)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29380609747373394)
,p_plug_template_id=>wwv_flow_imp.id(29380030879373393)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29380968118373394)
,p_plug_template_id=>wwv_flow_imp.id(29380030879373393)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29381220665373394)
,p_plug_template_id=>wwv_flow_imp.id(29380030879373393)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29381589269373394)
,p_plug_template_id=>wwv_flow_imp.id(29380030879373393)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29381803829373394)
,p_plug_template_id=>wwv_flow_imp.id(29380030879373393)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29382191396373395)
,p_plug_template_id=>wwv_flow_imp.id(29380030879373393)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29382464559373395)
,p_plug_template_id=>wwv_flow_imp.id(29380030879373393)
,p_name=>'Sub Regions'

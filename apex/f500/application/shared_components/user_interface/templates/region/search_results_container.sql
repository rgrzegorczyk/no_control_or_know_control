...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29397198836373404)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29397423712373404)
,p_plug_template_id=>wwv_flow_imp.id(29397198836373404)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29397760547373404)
,p_plug_template_id=>wwv_flow_imp.id(29397198836373404)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29398078653373404)
,p_plug_template_id=>wwv_flow_imp.id(29397198836373404)
,p_name=>'Sub Regions'

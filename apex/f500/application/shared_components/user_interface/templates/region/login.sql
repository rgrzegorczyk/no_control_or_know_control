...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29394692044373402)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29394929215373402)
,p_plug_template_id=>wwv_flow_imp.id(29394692044373402)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29395258402373402)
,p_plug_template_id=>wwv_flow_imp.id(29394692044373402)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29395592804373402)
,p_plug_template_id=>wwv_flow_imp.id(29394692044373402)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29395802388373402)
,p_plug_template_id=>wwv_flow_imp.id(29394692044373402)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29396157477373402)
,p_plug_template_id=>wwv_flow_imp.id(29394692044373402)
,p_name=>'Sub Regions'

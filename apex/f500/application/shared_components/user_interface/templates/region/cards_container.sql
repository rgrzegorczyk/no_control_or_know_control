...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29340946667373369)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29341293562373369)
,p_plug_template_id=>wwv_flow_imp.id(29340946667373369)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29341591294373369)
,p_plug_template_id=>wwv_flow_imp.id(29340946667373369)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(29341871595373369)
,p_plug_template_id=>wwv_flow_imp.id(29340946667373369)
,p_name=>'Sub Regions'
